...
from DFTWorkflow.pitchintATent import transformations , locateNans , eliminateNans
...
if __name__ == "__main__":
    ...
    chemType = str(sys.argv[4])
    dfMASTDir = str(sys.argv[5])
