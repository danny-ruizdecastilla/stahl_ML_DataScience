...
def generate_UMAP_tSNE(X, makeUMap:False):
...
def main(df:np.array , outputDir:str , featureType:str):
    ...
    dftSNE = kMeansCluster(df, f"{featureType}_tSNE_1", f"{featureType}_tSNE_2", 15, 45, "tSNE" , outputDir_tSNE)
